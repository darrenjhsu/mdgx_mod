...
//           assuming the format 10i8.  This function returns an array of
//           integers.                                               
//                                                                      
// Arguments:                                                           
//   Ctop:       the topology, in ascii format                          
...
void GetPrmTop(prmtop *tp, trajcon *tj, int adjbnd)
{
  ...
  if (npline > 0) {
    tp->ZNumber = Read10i8(&Ctop, &npline, tp->natom);
  }
  else {
...
//-----------------------------------------------------------------------------
// Format20a4: print a chunk of a topology file with this character     
//             format.                                                  
//
// Arguments:
//   cname:     the subsection header (i.e. "CHARGES")
...
void PutPrmTop(prmtop *tp, char* fname, char* title)
{
  ...
  Format5e16("BOND_STIFFNESS_PRESS_ADJ", tp->BondPressK, tp->nBAH.nbond, outp);
