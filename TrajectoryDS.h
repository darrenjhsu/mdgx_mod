...
struct TrajectoryControlData {
  ...
  int rattle;              // Flag to specify whether to constrain bonds to
                           //   hydrogen via RATTLE.
  ...
  cmat fmodfile;           // The force field parameter modification file(s)
                           //   (for fitting torsions and other terms)
